...
The [Void](/the-void) is the place in Fractalism where patterns weaken and another response becomes possible. In the Void, the automatic reinforcement of what is already assumed can be seen as an assumption rather than as fact. The loop can be noticed before it closes.
