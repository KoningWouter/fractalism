...
Start with the [Introduction](/introduction). It gives you the central premise and the main concepts in one place.

After that, [How to Read Fractalism](/how-to-read-fractalism) explains how to approach the project without flattening it into dogma or vague metaphor.

From there, [Core Concepts](/concepts) gives you the vocabulary, and the [Essays](/essays) show the framework in motion.
